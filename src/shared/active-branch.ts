...
export function clearActiveSelection() {
  document.cookie = `${ACTIVE_COMPANY_KEY}=; path=/; max-age=0; samesite=lax`
  document.cookie = `${ACTIVE_BRANCH_KEY}=; path=/; max-age=0; samesite=lax`
