...
import { loadCurrentStock } from "@/src/application/use-cases/dashboard/current-stock"
import { currentStockReducer, defaultFilters, initialCurrentStockState } from "@/src/ui/features/dashboard/current-stock/state"
...
// UI hook that loads current stock and exposes view-friendly state.
